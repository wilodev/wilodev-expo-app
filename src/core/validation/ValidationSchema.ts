...
type ValidationRule = {
	...
	isPhone?: {
		// Validation for phone numbers with pattern, minLength, maxLength, and custom messages.
	...
	isChecked?: boolean | string; // Checks for a valid checkbox state. Can be a boolean or a custom error message string.
};
