...
/**
 * HeaderTopBarBackgroundProps interface extends the properties of React Native 's HeaderTopBarBackgroundProps.
 * It provides customization options for the TabBarBackground component.
 */
export interface HeaderTopBarBackgroundProps extends GBox {
