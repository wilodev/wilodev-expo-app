/**
 * @fileOverview Styles for Image Component
 * @description This file provides style definitions for the Image component, offering
 ...
 *              and scaling the UI design of the Image component. The styles are designed
...
/**
 * Retrieves the default style for Image and variants.
 */
