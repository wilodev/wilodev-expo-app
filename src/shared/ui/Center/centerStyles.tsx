/**
 * @fileOverview Styles for Center Component
 * @description This file provides style definitions for the Center component, offering
 ...
 *              and scaling the UI design of the Center component. The styles are designed
 ...
 */
export const CenterStyle = styled(Center, {});
